...
test('Should show an erroe message if log in without a password', async ({loginPage}) => {
...
test('Should show an erroe message if log in with both fields blank', async ({loginPage}) => {
